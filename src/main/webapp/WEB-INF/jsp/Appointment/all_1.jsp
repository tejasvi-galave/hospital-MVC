    ...
    <tbody id="appointmentData">
        <c:forEach var="appointment" items="${appointmentList}">
            <tr>
                ...
                <td class="icon-center">
                    <a href="${pageContext.request.contextPath}/appointments/details?id=${appointment.appointmentId}" class="btn-small btn-details">Details</a>
                </td>
                <td class="icon-center">
                    <a href="${pageContext.request.contextPath}/diagnosis/add?appointmentId=${appointment.appointmentId}" class="btn-small btn-diagnosis">Add</a>
                </td>
            </tr>
        </c:forEach>
    </tbody>
        ...
        input.addEventListener("input", async function () {
            ...
            try {
                ...
                if (data.length === 0) {
                    tbody = `
                        <tr>
                            <td colspan="10" style="text-align:center;">No appointment found</td>
                        </tr>`;
                } else {
                    data.forEach(list => {
                        tbody += `
                            <tr>
                                ...
                                <td>\${list.phone}</td>
                                <td class="icon-center">
                                    <a href="${pageContext.request.contextPath}/appointments/AppointmentById?id=\${list.appointmentId}" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                </td>
                                <td class="icon-center">
                                    <a href="${pageContext.request.contextPath}/appointments/details?id=\${list.appointmentId}" class="btn-small btn-details">Details</a>
                                </td>
                                <td class="icon-center">
                                    <a href="${pageContext.request.contextPath}/diagnosis/add?appointmentId=\${list.appointmentId}" class="btn-small btn-diagnosis">Add Diagnosis</a>
                                </td>
                            </tr>`;
                    });
                }
